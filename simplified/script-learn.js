(() => {
  ...
  class Zd {
      ...
      constructor(e, t, n, debounceMs) {
          ...
          }), void 0 !== t && t.defineInitHook(this.editorHook()), this.debounceMs = debounceMs ?? 0
      }
      editorHook() {
  ...
  class aE {
      ...
      constructor(e, t, n, r, a, i) {
          ...
          }), this), this.keybindings = async function(extensionId) {
      ...
      fE = e => Object.defineProperties(window, {
          ...
          monaco: {
              ...
              set(t) {
                  ...
                  const r = new MonacoCompletionProvider(extensionId, n, e);
  ...
  const SE = (e, t) => {
                      ...
                      if (Object.prototype.hasOwnProperty.call(this, "Jupyter")) {
                          ...
                          for (const t of NE)
                              if (t.pattern.test(window.location.href)) {
                                  ...
                                  break
                              } pE && (new Zd(extensionId, n, e, t), console.log(`Codeium: Activating CodeMirror Site: ${r}`))
                      }
      ...
      CE = new Zd(extensionId, void 0, !1),
      OE = CE.editorHook(),
      yE = () => {
          const e = setInterval((() => {
  ...
  }(extensionId), async function(extensionId) {
      return await new Promise((t => {
          chrome.runtime.sendMessage(extensionId, {
              type: "debounce_ms"
          }, (e => {
